...
The portfolio assistant should expose the knowledge-base version and last-updated date near its AI limitation notice or answer citations. This allows a visitor and the owner to identify which profile snapshot produced an answer.

## KB-01 — Identity and public names

- Public professional name: **John Chong**.
...
## KB-02 — Professional summary

John is an AI product, application and workflow builder with a client-facing delivery background. He works between an unclear business or product request and a working, testable result.
...
## KB-03 — Current role direction

John is primarily interested in Hong Kong roles such as:
...
## KB-04 — Hong Kong work eligibility and availability

- John is a Hong Kong permanent resident.
...
- Cantonese: native-level professional communication.
...
## KB-07 — Early professional experience

John worked as a Marketing Specialist in the auto-insurance marketing department of Ping An Property & Casualty Insurance, Shenzhen Branch, from May 2013 to November 2013.
...
## KB-09 — Why the founder-to-full-time transition makes sense

John is looking for a full-time Hong Kong role because sustained work inside a team would add the formal AI and company experience that his current background does not yet provide. A stable role is therefore aligned with his own long-term interests.
...
## KB-10 — Working method

John's repeatable delivery loop is:
...
## KB-11 — Human responsibility in Agent-assisted products

AI Agents can complete substantial research, implementation, testing and documentation, but task completion is not the same as a product being suitable for people.
...
FightGame contains three distinct AI or guidance mechanisms:
...
## KB-14 — FightGame development and UAT
...
## KB-16 — Human-in-the-loop AI video workflow

**Project type:** delivered AI video production workflow.<br>
...
## KB-17 — Observable AI video channel reference P0

**Project type:** simulated P0 reference for observable AI video-channel orchestration.<br>
**John's role:** Product & Delivery Lead.
...
## KB-18 — Additional supporting work

Depending on the target role, John can also discuss:
...
## KB-19 — Technical exposure

Technologies used across selected work include:
...
## KB-20 — Strengths relevant to employers

- translating unclear requirements into an executable product scope;
...
The assistant interface may suggest:
...
### Did John manually write all the code?
...
## KB-24 — Information the assistant must not provide

The public assistant must refuse or state that the information is not available when asked for:
