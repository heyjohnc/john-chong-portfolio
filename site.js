(function () {
  ...
  const zh = {
    ...
    "A 79-card system makes tactical depth visible.": "79 張技能卡，讓戰術深度變得可見。",
    "The code-verified catalogue covers deck limits, elements, counters, statuses and combo setup/payoff. The collection image is an illustrative visualization of that breadth, not a literal screenshot of all 79 production cards.": "經程式碼核實的卡牌目錄涵蓋牌組限制、元素、反制、狀態，以及連招的鋪墊與收益。下方收藏圖用於示意這個廣度，並非全部 79 張正式卡牌的逐張截圖。",
    "Illustrative visualization of the FightGame skill-card catalogue, not a screenshot of all 79 verified cards": "FightGame 技能卡目錄示意圖，並非全部 79 張已核實卡牌的逐張截圖",
    "Illustrative collection view": "收藏規模示意圖",
    "79-card catalogue verified in code": "79 張卡牌目錄已由程式碼核實",
    "Visual grouping represents the system's breadth; individual artwork and layout are illustrative.": "視覺分組用於呈現系統廣度；個別卡面及版面均屬示意。",
