(function () {
  ...
  const zh = {
    ...
    "Nine working systems, organized by evidence depth: two end-to-end products, five applied AI workflows and two open-source utilities.": "九個可運作系統，按證據深度整理：兩個端到端產品、五個應用型 AI 工作流程及兩個開源實用工具。",
    "End-to-End Products": "端到端產品",
    "Applied AI Workflows": "應用型 AI 工作流程",
    "Open-Source Utilities": "開源實用工具",
    ...
    "Nine selected projects show both depth and range: two end-to-end products, five applied AI workflows and two open-source utilities. Every item separates my decisions from Agent-accelerated implementation.": "九項精選作品同時展示深度與廣度：兩個端到端產品、五個應用型 AI 工作流程，以及兩個開源實用工具。每一項都清楚區分我的決策與 Agent 加速實作。",
    "Five ways I turn complex workflows into controlled products.": "五種把複雜流程轉化為受控產品的方式。",
    "Compact evidence of workflow design, safety boundaries, data provenance and acceptance—without inflating each workflow into an end-to-end product claim.": "以精簡證據呈現工作流程設計、安全邊界、資料來源及驗收，不把每項工作流程誇大為端到端產品。",
    ...
    "Playable product · accepted milestone": "可玩產品 · 里程碑已驗收",
    "Client–server product": "客戶端—伺服器產品",
    "Three connected contexts": "三個相連場景",
    "01 · Identity": "01 · 身份",
    "Profile & loadout": "個人檔案與卡組",
    "02 · Presence": "02 · 在線場景",
    "Shared world": "共享世界",
    "03 · Resolution": "03 · 結算",
    "Online battle": "線上對戰",
    "Player intentions": "玩家意圖",
    "Server authority": "伺服器權威",
    "Validate · resolve · persist": "驗證 · 結算 · 持久化",
    "One shared outcome": "一個共享結果",
    "Phaser client": "Phaser 客戶端",
    "Colyseus rooms": "Colyseus 房間",
    "Express APIs": "Express API",
    "Controlled multi-Agent system": "受控多 Agent 系統",
    "Four roles · separated authority": "四個角色 · 權限分離",
    "01 · In-game decision layer": "01 · 遊戲內決策層",
    "Four roles vote before the shared result.": "四個角色先投票，再產生共享結果。",
    "02 · Agent dialogue window": "02 · Agent 對話視窗",
    "Distinct voices react to one recorded state.": "不同角色根據同一個已記錄狀態作出反應。",
    "4 votes": "四票",
    "Policy gates": "策略閘門",
    "Lark · discovery": "Lark · 發現",
    "Niulai · vote": "Niulai · 投票",
    "Mama & Baola · publishing": "牛來媽媽與豹拉 · 發佈",
    "01 · End-to-end product": "01 · 端到端產品",
    "Personalized-Avatar Multiplayer Pixel RPG": "個人化角色多人像素 RPG",
    ...
    "Read the FightGame case study and its client-server architecture": "閱讀 FightGame 案例及其客戶端—伺服器架構",
    "Read the Niulai Squad case study and its controlled multi-Agent architecture": "閱讀牛來生米小隊案例及其受控多 Agent 架構",
    "FightGame architecture connecting persistent identity, shared-world presence and synchronized battle through an authoritative server": "FightGame 架構：以權威伺服器連接持久身份、共享世界在線狀態及同步對戰",
    "Niulai Squad architecture connecting four bounded Agent roles through evidence, voting, policy gates and one canonical timeline": "牛來生米小隊架構：以證據、投票、策略閘門及一條規範時間線連接四個受限 Agent 角色",
    ...
    "← Projects": "← 項目",
    "FightGame · End-to-End Product": "FightGame · 端到端產品",
    ...
    "Niulai Squad · End-to-End Product": "牛来生米小队 · 端到端產品",
    "Four-Agent Decision & Publishing System": "四 Agent 決策與發佈系統",
    ...
    "Playable personalization loop": "可玩的個人化流程",
    "One reference image becomes one identity across the game.": "一張參考圖片，成為貫穿整個遊戲的同一身份。",
    "Six product captures show the complete path: request a custom skin, let the asynchronous generation job finish, then carry the approved avatar into the shared world and battle.": "六張產品畫面呈現完整路徑：申請自訂造型、等待非同步生成完成，再把確認後的角色帶進共享世界與戰鬥。",
    "FightGame custom skin generation and use flow": "FightGame 自訂造型生成及使用流程",
    "FightGame Custom Skin upload dialog": "FightGame 自訂造型上傳對話框",
    "FightGame skin reference upload in progress": "FightGame 正在上傳造型參考圖片",
    "FightGame Custom Skin generation status": "FightGame 自訂造型生成狀態",
    "Generated FightGame pixel avatar": "生成後的 FightGame 像素角色",
    "Generated avatar active in the FightGame shared world": "生成角色已在 FightGame 共享世界啟用",
    "Generated avatar carried into a FightGame battle": "生成角色已帶入 FightGame 戰鬥",
    "01 · Select": "01 · 選擇",
    "Open Custom Skin": "開啟自訂造型",
    "02 · Upload": "02 · 上傳",
    "Submit a reference image": "提交參考圖片",
    "03 · Generate": "03 · 生成",
    "Wait for the skin job": "等待造型任務完成",
    "04 · Review": "04 · 檢視",
    "Confirm the generated avatar": "確認生成角色",
    "05 · Explore": "05 · 探索",
    "Use the same identity in-world": "在世界中使用同一身份",
    "06 · Battle": "06 · 戰鬥",
    "Carry the identity into combat": "把同一身份帶入戰鬥",
    "One identity, three contexts.": "同一身份，三個場景。",
    "The generated skin is not a detached demo output; it becomes the active avatar used by profile, overworld and battle views.": "生成造型不是脫離產品的展示輸出；它會成為玩家資料、世界地圖及戰鬥畫面共用的啟用角色。",
    "Mechanical breadth": "玩法廣度",
    "A complete 79-card system makes tactical depth inspectable.": "完整的 79 張技能卡系統，讓戰術深度可被檢視。",
    "The complete collection board shows all 79 cards at once: 40 Common, 30 Uncommon and nine Premium cards across Rare, Epic and Legendary tiers. Together they support deck limits, elements, counters, statuses and combo setup/payoff.": "完整收藏板一次呈現全部 79 張卡牌：40 張 Common、30 張 Uncommon，以及 9 張涵蓋 Rare、Epic 與 Legendary 等級的 Premium 卡牌。整個系統支援牌組限制、元素、反制、狀態，以及連招的鋪墊與收益。",
    "Open the full 79-card FightGame collection board": "開啟完整的 FightGame 79 張技能卡收藏板",
    "Complete FightGame collection board showing all 79 skill cards by rarity": "完整 FightGame 收藏板，按稀有度呈現全部 79 張技能卡",
    "Complete collection board": "完整收藏板",
    "79 cards · one inspectable system": "79 張卡牌 · 一個可檢視系統",
    "40 Common · 30 Uncommon · 9 Premium across Rare, Epic and Legendary tiers.": "40 張 Common · 30 張 Uncommon · 9 張 Premium，涵蓋 Rare、Epic 與 Legendary 等級。",
    "View full collection ↗": "查看完整收藏板 ↗",
    ...
    "02 · End-to-end product": "02 · 端到端產品",
  ...
  const pageMetaZh = {
    ...
    "Personalized-Avatar Multiplayer Pixel RPG — FightGame | John Chong": "個人化角色多人像素 RPG — FightGame | John Chong",
    "Four-Agent Decision & Publishing System — Niulai Squad | John Chong": "四 Agent 決策與發佈系統 — 牛来生米小队 | John Chong",
    ...
    "Nine selected projects by John Chong: two end-to-end products, five applied AI workflows and two open-source utilities.": "John Chong 的九個精選項目：兩個端到端產品、五個應用型 AI 工作流程及兩個開源實用工具。",
